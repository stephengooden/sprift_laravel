...
@section('content')
    <div class="mobheader" style="display: none">
        <div class="inner">
            ...
            <img src="{{ asset('img/logo_white.png') }}" alt="" class="minlogo"/>
            <div style="float:right">
                <a class="btn" href="javascript:void(0);" onclick="$('.mobheader').toggleClass('active')"> <i class="fa fa-bars"></i></a>
            </div>
        </div>
        ...
        <div class="inner vcenter">
            <header class="sec-header">
                <div class="text-center">
                    <img src="{{ asset('img/logo_white.png') }}" alt="" class="sprift-logo"/>
                </div>
...
{{--     <section id="sec7" class="sheet section sec7">
        ...
        <div class="inner vcenter">
            <div class="content">
                <div class="container-bs charcont">
                    ...
                    <div class="rowflex" style="flex-direction: column !important;">
                        <div class="full-row">
                            ...
                            <div class="graph-box" style="max-width: 100% !important;">
                                <div style="min-width: 800px !important; max-width: 800px !important;" id="listed-propreties-bar" class="chart"></div>
                ...
                <div class="container-bs charcont">
                    <div class="rowflex" style="flex-direction: column !important;">
                        <div class="full-row">
                            ...
                            <div class="graph-box">
                                <div style="min-width: 800px !important; max-width: 800px !important;" id="listed-propreties-by-value-bar" class="chart"></div>
    ...
    <section id="sec8" class="sheet section sec8">
        <div class="rowflex fullh">
            <div class="half-ofrow first-ofrow thiweekbg halfaimg" style="width: 30%; background-size: cover; background-repeat: no-repeat; background-image: url('{{asset('/images/default/key.jpg')}}')">
            </div>
            <div class="half-ofrow second-ofrow" style="width: 70%">
                <div class="right-inner" style="padding-right: 20px">
                    ...
                    <div class="graph-box" style="margin-top: 30px; max-width: 100%">
                        <div id="agency-bar" style="min-width: 650px !important; max-width: 650px !important;"></div>
    ...
    <section id="sec9" class="sheet section sec9">
        <div class="rowflex fullh">
            ...
            <div class="half-ofrow second-ofrow halfaimg" style="background-size: cover; background-repeat: no-repeat; background-image: url('{{$report['img4']}}');">
    ...
    @if(count($report['recently_listed'])>0)
            ...
            <div class="content">
                <div class="container-bs">
                    ...
                    <div class="txt1-group">
                        ...
                        <p>The properties in {{ $postcode }} have been on the market 1 year</p>
                   </div>
                    <div class="infogrey-table">

                        @php $pos = 1; $ostl = count(array_slice($report['recently_reduced'], 0, 6)); @endphp
                ...
                <div class="container-bs">
                    ...
                    <div class="rowflex">
                        <div class="half-ofrow">
                            <div class="infogrey-table half-table left-table">
                                <h3>3+ months </h3>
                                @php $pos = 1; $ostl = count(array_slice($report['recently_reduced'], 0, 3)); @endphp
                                @foreach($report['recently_reduced'] as $elm)
                                    @if($pos<=3)
                                        <div>
                                            <div class="infogrey-table-row {{($ostl<5 ? 'bigit' : '')}}">
                        ...
                        </div><div class="half-ofrow">
                            <div class="infogrey-table half-table right-table">
                                <h3>6+ months </h3>
                                @php $pos = 1; $ostl = count(array_slice($report['recently_reduced'], 0, 3)); @endphp
                                @foreach($report['recently_reduced'] as $elm)
                                    @if($pos<=3)
